...
<body>
	<div style="background: url(https://www.heet.org.uk/wp-content/uploads/2016/06/gradient-background-26046-26731-hd-wallpapers.jpg.png) !important" class="jumbotron">
		...
		<%--posts images of available books and scales them accordingly--%>
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item"> <a class="page-link" href="shop.jsp">Previous</a>
    </li>
    ...
    <li class="page-item">
      <a class="page-link" href="shop3.jsp">Next</a>
    </li>
  </ul>
</nav>
